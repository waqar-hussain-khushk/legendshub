...
<button name="update" style="color: #000; background: #facc04; border: 1px solid #000;" class="btn btn-primary" >
...
$update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',customer_city='$c_city',customer_contact='$c_contact',customer_address='$c_address',customer_image='$c_image' where customer_id='$update_id'";
